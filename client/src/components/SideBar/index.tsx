    ...
    <div className={sideBarClassName}>
      <div className="flex h-[100%] w-full flex-col justify-start">
        ...
        <div className="z-50 flex min-h-[56px] w-64 items-center justify-between bg-white px-6 pt-3 dark:bg-black">
          <div className="cursor-pointer text-xl font-bold text-gray-800 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-900">
            PIVOT
          </div>
        ...
        <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
          <Image
            src="https://ad-s3-images.s3.ap-southeast-2.amazonaws.com/logo_P.png"
            alt="__TEAM_LOGO__"
            width={40}
            height={40}
        ...
        <button
          ...
          className="flex w-full items-center justify-between px-8 py-3 text-gray-500 dark:text-gray-100"
        >
